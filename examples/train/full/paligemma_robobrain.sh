...
swift sft \
    ...
    --check_model false \
    --train_type lora \
    --dataset ShareRobot/affordance ShareRobot/trajectory ShareRobot/planning\
    ...
    --output_dir output/PaliGemma_RoboBrain \
    ...
    --deepspeed zero3 \
    > output/PaliGemma_RoboBrain/outputs.log 2>&1
